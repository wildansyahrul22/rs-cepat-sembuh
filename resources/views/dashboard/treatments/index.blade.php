...
<div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
    <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center">
        ...
        <div class="flex items-center gap-2">
            <form action="{{ route('dashboard.treatments.index') }}" method="GET" class="flex items-stretch h-10">
            ...
            <a href="{{ route('dashboard.treatments.create') }}" class="text-sm text-green-600 font-medium hover:underline">Tambah</a>
        </div>
    </div>
